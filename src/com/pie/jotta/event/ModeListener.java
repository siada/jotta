...
public class ModeListener implements MessageListener {

	public void recieve(IRCMessage message) {
		if(message.getCommand().equals("MODE") && message.getModeOn() != null) {
			Logger.getInstance().log(message.getSender()+" sets mode: "+message.getMode()+" "+message.getModeOn());
		}
	}
